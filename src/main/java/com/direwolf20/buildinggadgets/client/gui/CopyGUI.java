...
/// area. It should have two sets of x, y, and z sliders. There are two modes for the system. Relative and absolute mode.
...
///   - CoordsMode
///
/// When Okay is clicked the changes made in the gui should persist to the gadgets nbt data and the gui should be closed.
...
///
/// ## Relative mode
/// The first set is the "start" sliders. They should always start at zero. When the dialog is closed these values should
...
///
/// ## Absolute mode
/// The first set of sliders should contain the actual absolute position of the start pos. Ie 59, 102, 90. The second set
...
public class CopyGUI {
    public static ModularScreen createGUI() {
        ...
        panel.child(IKey.str("Copy").asWidget()
                .top(7).left(7));
