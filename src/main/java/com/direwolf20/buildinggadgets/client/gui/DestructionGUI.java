...
//                .rightRel(0.3f));
    ...
    public ModularPanel buildUI(ModularGuiContext context) {
        ...
        var buttonPanel = new Row()
                ...
                .child(
                        new ToggleButton()
                                .overlay(false, GuiUtils.getUITextureFromResource("anchor"))
                ...
                .child(
                        new ToggleButton()
                                .overlay(false, GuiUtils.getUITextureFromResource("connected_area"))
                ...
                .child(
                        new ToggleButton()
                                .overlay(false, GuiUtils.getUITextureFromResource("raytrace_fluid"))
