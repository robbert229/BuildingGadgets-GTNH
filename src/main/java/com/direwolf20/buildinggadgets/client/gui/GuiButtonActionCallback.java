...
public class GuiButtonActionCallback extends GuiButtonIcon {
    ...
    public GuiButtonActionCallback(String name, ScreenPosition screenPosition, Predicate<Boolean> action) {
        this(
            ...
            0,
            0,
            String.join(".", "tooltip.gadget", name),
            Color.GREEN,
            Color.GRAY,
            Color.WHITE,
            new ResourceLocation(
                BuildingGadgets.MODID,
                String.format("textures/gui/setting/%s.png", name.replace(".", "_"))),
            screenPosition,
            action);
    ...
    public GuiButtonActionCallback(int x, int y, int width, int height, String helpTextKey, Color colorSelected,
        Color colorDeselected, Color colorHovered, ResourceLocation texture, ScreenPosition screenPosition,
