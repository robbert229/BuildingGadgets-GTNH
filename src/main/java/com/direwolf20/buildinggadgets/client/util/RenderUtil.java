...
public final class RenderUtil {
    ...
    public static void renderTextHorizontalRight(String text, int rightX, int y, int color) {
        getFontRenderer()
            .drawString(text, getXForAlignedRight(getFontRenderer().getStringWidth(text), rightX), y, color);
    }

    public static void renderTextHorizontalMiddle(String text, int leftX, int rightX, int y, int color) {
        getFontRenderer()
            .drawString(text, getXForAlignedCenter(getFontRenderer().getStringWidth(text), leftX, rightX), y, color);
    }
    ...
    public static void renderTextVerticalCenter(String text, int x, int topY, int bottomY, int color) {
        getFontRenderer()
            .drawString(text, x, getYForAlignedCenter(getFontRenderer().FONT_HEIGHT, topY, bottomY), color);
    }
