...
// @net.minecraftforge.common.config.Config(modid = BuildingGadgets.MODID, name = "Building Gadgets", category =
...
public class Config {
    ...
    // @Comment({"Whether the Building / CopyPaste Gadget can overwrite blocks like water, lava, grass, etc (like a
    // player can).",
    ...
    public static final class CategoryBlacklist {
        ...
        // "Notice that you can use Regular Expressions as defined by Java Patterns to express more complex name
        // combinations.",
        // "Use for example \"awfulmod:.*\" to blacklist all awfulmod Blocks."})
        // @LangKey(LANG_KEY_BLACKLIST + " + blockBlacklist")
        public String[] blockBlacklist = { "minecraft:.*_door.*",
            Block.blockRegistry.getNameForObject(Blocks.piston_head), "astralsorcery:blockflarelight", };
    }
    ...
    // using unistantiable final class instead of enum, so that it doesn't cause issues with the ConfigManger trying to
    ...
    public static final class CategoryGadgets {
        ...
        public static final class CategoryGadgetDestruction {
            ...
            // @Comment("If enabled, the Destruction Gadget can be taken out of fuzzy mode, allowing only instances of
            // the block "
