...
/**
 * This class differs from {@link BufferBuilder BufferBuilder} only in that the Comparator arguments of
 * {@link Arrays#sort(Integer[], Comparator) Arrays#sort}
...
public class ToolDireBuffer {
    ...
    // this.vertexFormat.getNextOffset() + p_181670_1_ > this.byteBuffer.capacity()) {
    // int i = this.byteBuffer.capacity();
    // int j = i + MathHelper.roundUp(p_181670_1_, 2097152);
    // LOGGER.debug("Needed to grow BufferBuilder buffer: Old size {} bytes, new size {} bytes.", Integer.valueOf(i),
    // Integer.valueOf(j));
    ...
    //
    // for (int j = 0; j < i; ++j) {
    // afloat[j] = getDistanceSq(this.rawFloatBuffer, (float) (p_181674_1_ + this.xOffset), (float) (p_181674_2_ +
    // this.yOffset), (float) (p_181674_3_ + this.zOffset), this.vertexFormat.getIntegerSize(), j *
    // this.vertexFormat.getNextOffset());
    // }
    //
    ...
    // }
    //
    // private static float getDistanceSq(FloatBuffer p_181665_0_, float p_181665_1_, float p_181665_2_, float
    // p_181665_3_, int p_181665_4_, int p_181665_5_) {
    ...
    // Float.intBitsToFloat(this.rawIntBuffer.get(l))));
    // this.rawIntBuffer.put(i1, Float.floatToRawIntBits((float) (y + this.yOffset) +
    // Float.intBitsToFloat(this.rawIntBuffer.get(i1))));
    // this.rawIntBuffer.put(j1, Float.floatToRawIntBits((float) (z + this.zOffset) +
    // Float.intBitsToFloat(this.rawIntBuffer.get(j1))));
    // }
    // }
    //
    // /**
